...
public class PanelIntersection extends CenterPanel {
	...
	private JLabel heading, intersection, intersection_desc;
	...
	public PanelIntersection(Function function1, Function function2) {
		...
		intersection_desc = new JLabel(Strings.getStringAsHTML("PanelIntersection.label_intersection_desc"), SwingConstants.CENTER); //$NON-NLS-1$
